...
const styles = StyleSheet.create({
  ...
  orderNumber: { fontSize: 24, marginBottom: 20 },
  box: { border: "1 solid black", padding: 10, marginBottom: 20 },
  circle: {
    width: 24,
    height: 24,
    borderRadius: 12,
  ...
  checkbox: { width: 15, height: 15, border: "1 solid black", marginRight: 5 },
});
