          ...
          <div className="container max-w-6xl h-full mx-auto">
            <div className="hidden flex-col md:grid md:grid-cols-3 relative pb-4 w-full">
              ...
              <div className="flex flex-col h-full items-center text-center step-item step-item-2 px-2 mb-8 md:mb-0">
                ...
                <p className="text-[18px] text-[#4A544A] mt-4">
                  Wir erstellen ein Tagespack, das auf Dich und deine Ziele zugeschnitten
                  ist.
                </p>
              </div>

              <div className="flex flex-col h-full items-center text-center step-item step-item-3 px-2">
                <Image
            ...
            <div className="md:hidden flex flex-col relative p-4 w-full">
              <div
                className="absolute left-[21px] w-[2px] m-4 bg-[#D7E0D7] z-0"
                style={{ top: "200px", bottom: "70px" }}></div>
              ...
              <div className="flex flex-col h-full items-start text-left step-item step-item-2 pl-16 pr-4 mb-8 relative space-y-1">
                ...
                <p className="text-[18px] text-[#4A544A] mt-4">
                  Wir erstellen ein Vitamin- & Mikronährstoff-Tagespack, das auf Dich und
                  deine Ziele zugeschnitten ist.
                </p>
              </div>
