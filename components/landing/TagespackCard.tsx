...
export default function TagespackCard() {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center px-4 w-full">
      <div className="relative w-full max-w-[700px] bg-gradient-to-b from-primary to-[#374735] rounded-[36px] p-6 text-white flex flex-col justify-end space-y-2 overflow-visible mb-12 drop-shadow-[0_35px_35px_rgba(56,71,55,0.5)] h-fit z-30 lg:rotate-[-1deg]">
        <Image
          src={tagespack}
          alt="tagespack"
