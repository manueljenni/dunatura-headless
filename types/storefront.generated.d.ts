...
export type GetIngredientsQueryVariables = StorefrontTypes.Exact<{ [key: string]: never; }>;
...
export type CartLinesAddMutationVariables = StorefrontTypes.Exact<{ [key: string]: never; }>;
